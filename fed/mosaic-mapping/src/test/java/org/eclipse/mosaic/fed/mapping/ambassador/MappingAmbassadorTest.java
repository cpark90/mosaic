...
public class MappingAmbassadorTest {
    ...
    private MappingAmbassador createMappingAmbassadorWithMappingFile(String fileName) throws Exception {

        File mappingFile = tmpFolder.newFile(fileName);
        FileUtils.copyInputStreamToFile(this.getClass().getClassLoader().getResourceAsStream(fileName), mappingFile);
