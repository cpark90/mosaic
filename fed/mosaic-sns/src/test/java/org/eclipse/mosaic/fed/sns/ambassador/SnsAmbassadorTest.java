...
public class SnsAmbassadorTest {
    ...
    public void setup() throws Exception {
        ...
        File applicationConfig = temporaryFolder.newFile("sns_config_complex_multihop_test.json");
        FileUtils.copyInputStreamToFile(this.getClass().getResourceAsStream("/sns_config_complex_multihop.json"), applicationConfig);

        final File configurationFile =
                new File(Objects.requireNonNull(applicationConfig).toURI());
