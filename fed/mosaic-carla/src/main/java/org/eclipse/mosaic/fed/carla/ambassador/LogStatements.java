...
abstract class LogStatements {
    ...
    static String CARLA_BYTE_ARRAY_MESSAGE = "CARLA byte array message received";
    ...
    static String MISSING_CARLA_CONFIG = "The CARLA Ambassador cannot be started without a valid configuration file (*.carlacfg is missing).";

    /**
     * Prints CARLA start message to the console.
     */
    static void printStartCarlaGuiInfo() {
        System.out.println(StringUtils.repeat("=", 70));
        System.out.println("| CARLA will now be started in GUI Mode." + StringUtils.repeat(" ", 30) + "|");
        System.out.println("| Please make sure you have started Eclipse MOSAIC with \"-w 0\"" + StringUtils.repeat(" ", 7) + "|");
        System.out.println("| Start the simulation manually in CARLA-GUI." + StringUtils.repeat(" ", 25) + "|");
        System.out.println(StringUtils.repeat("=", 70));
    }
}
