...
import org.eclipse.mosaic.fed.carla.util.SumoVehicleTypesWriter;
...
/**
 * Implementation of a {@link AbstractCarlaAmbassador} for the driving simulator
 ...
 * @see VehicleUpdates
 */
public class CarlaAmbassador extends AbstractCarlaAmbassador {
    ...
    private void receiveInteraction(VehicleRegistration vehicleRegistration) {
        ...
        boolean subscribeToVehicle = carlaConfig.subscribeToAllVehicles || vehicleMapping.hasApplication();
