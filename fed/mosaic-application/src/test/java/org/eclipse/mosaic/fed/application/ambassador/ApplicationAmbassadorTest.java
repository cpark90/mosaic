...
public class ApplicationAmbassadorTest {
    ...
    public void loadJarOnStartup() throws Exception {
        ...
        File applicationConfig = tmpFolder.newFile("application_config_test.json");
        FileUtils.copyInputStreamToFile(this.getClass().getResourceAsStream("/application_config.json"), applicationConfig);
