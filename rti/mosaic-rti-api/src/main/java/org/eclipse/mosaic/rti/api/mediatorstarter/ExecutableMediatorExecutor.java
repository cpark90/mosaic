...
/**
 * A {@link MediatorExecutor} implementation which starts a federate (e.g. executable) by calling a command.
 */
public class ExecutableMediatorExecutor implements MediatorExecutor {

    private static Logger log = LoggerFactory.getLogger(ExecutableMediatorExecutor.class);
    ...
    public ExecutableMediatorExecutor(FederateDescriptor descriptor, String command, String... args) {
        this(descriptor, command, Arrays.asList(args));
    }

    public ExecutableMediatorExecutor(FederateDescriptor descriptor, String command, List<String> args) {
    ...
    @Override
    public Process startLocalMediator(File fedDir) throws MediatorStarterException {
    ...
    @Override
    public int startRemoteMediator(CLocalHost host, PrintStream sshStreamOut, InputStream sshStreamIn) throws MediatorStarterException {
